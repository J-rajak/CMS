...
public class BibmPage extends JDialog {
	...
	public BibmPage() {
		...
		optionalOneComboBox.setModel(new DefaultComboBoxModel(new String[] {"Probability", "Organizing Skills"}));
		...
		optionalTwoComboBox.setModel(new DefaultComboBoxModel(new String[] {"LPS", "PPD"}));
		...
		confirmBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String insertQuery = "INSERT INTO `bds_optional_modules` (`Id`, `Optional_One`, `Optional_Two`)"
						+ " VALUES (NULL, '"+selectedOptionalOneFromComboBox+"', '"+selectedOptionalTwoFromComboBox+"');";
				try {
					int insertSuccess = statement.executeUpdate(insertQuery);
					if (insertSuccess == 1) {
						 JOptionPane.showMessageDialog(levelSixPanel,"Information Saved!!"); 
					}
		...
		JLabel level6Mod1 = new JLabel("Project Based Learning");
		
		JLabel level6Mod2 = new JLabel("Project Development");
		...
		JLabel level5Mod1 = new JLabel("Statistics");
		
		JLabel level5Mod2 = new JLabel("Marketing");
		
		JLabel level5Mod3 = new JLabel("Sales");
		
		JLabel level5Mod4 = new JLabel("Managerial Skills");
		...
		JLabel level4Mod1 = new JLabel("Business Maths");
		
		JLabel level4Mod2 = new JLabel("Finance");
		
		JLabel level4Mod3 = new JLabel("History");
		
		JLabel level4Mod4 = new JLabel("Investment");
