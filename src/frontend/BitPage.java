	...
	public BitPage() {
		...
		confirmBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String insertQuery = "INSERT INTO `bit_optional_modules` (`Id`, `Optional_One`, `Optional_Two`)"
		...
		JLabel level6Mod1 = new JLabel("DSA");
		
		JLabel level6Mod2 = new JLabel("Big Data");
		...
		optionalOneComboBox.setModel(new DefaultComboBoxModel(new String[] {"Networking", "Model Designing"}));
		

		optionalTwoComboBox.setModel(new DefaultComboBoxModel(new String[] {"Robotics", "Statistics"}));
		...
		JLabel level5Mod2 = new JLabel("Embedded System");
		
		JLabel level5Mod3 = new JLabel("Concepts AI");
		
		JLabel level5Mod4 = new JLabel("NMC");
		...
		JLabel level4Mod1 = new JLabel("Introductory Programming");
		
		JLabel level4Mod2 = new JLabel("ISA");
		
		JLabel level4Mod3 = new JLabel("Database");
		
		JLabel level4Mod4 = new JLabel("OODP");
